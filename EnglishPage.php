...
<body>
    <div class="sidebar">
        ...
        <div class="section">
            ...
            <button id="saveAsPdfButton"><i class="fas fa-file-pdf"></i> Save As PDF</button>
            <button id="saveAsDocxButton"><i class="fas fa-file-word"></i> Save As DOCX</button>
            <input type="file" id="openDocxButton" accept=".docx" style="display: none;">
<button id="uploadDocxButton"><i class="fas fa-file-upload"></i> Open DOCX</button>

            <button onclick="window.location.href='dashboard.php'"><i class="fas fa-arrow-left"></i> Back to Dashboard</button>
        </div>
    ...
    <option value="'Courier New'">Courier New</option>
        ...
        <option value="8">8</option><option value="10">10</option><option value="12">12</option><option value="14">14</option><option value="16">16</option><option value="18">18</option><option value="20">20</option><option value="22">22</option><option value="24">24</option><option value="26">26</option><option value="28">28</option><option value="30">30</option><option value="32">32</option><option value="34">34</option><option value="36">36</option><option value="38">38</option><option value="40">40</option><option value="42">42</option><option value="44">44</option><option value="46">46</option><option value="48">48</option>    </select>
            <button id="boldButton"><i class="fas fa-bold"></i> Bold</button>
            <button id="italicButton"><i class="fas fa-italic"></i> Italic</button>
            <button id="underlineButton"><i class="fas fa-underline"></i> Underline</button>
        </div>

        <div style="margin-bottom: 20px;">
    <button id="insertImageButton" class="insert-image-button">Insert Image</button>
    <input type="file" id="imageInput" accept="image/*" style="display: none;">
</div>

<input type="hidden" id="docId" value="3d0bceea-8f40-43b7-9773-974f68828cb6">
    ...
    <div id="tableControls" style="display: none; margin-top: 10px;">
        <div class="table-controls">
            ...
            <button id="createTableButton" class="create-button" style="
    background: #ff4757;
">Create</button>
        ...
        <div class="section">
            ...
            <div class="align-buttons">
                <button id="alignLeft"><i class="fas fa-align-left"></i> Left</button>
                <button id="alignCenter"><i class="fas fa-align-center"></i> Center</button>
                <button id="alignRight"><i class="fas fa-align-right"></i> Right</button>
                <button id="alignJustify"><i class="fas fa-align-justify"></i> Justify</button>
            </div>
        </div>
    </div>
    ...
    <div class="ruler-line">
        <input type="range" id="lineStart" min="0" max="210" value="0" title="Line Start">
        <input type="range" id="lineEnd" min="0" max="210" value="210" title="Line End">
    </div>
</div>
